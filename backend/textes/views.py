...
from .serializers import RawTextBaseSerizlizer, RawTextDetailSerizlizer
from es_items.services import EsItemsService


class RawTextView(ListCreateAPIView):
    queryset = RawText.objects.all()
    serializer_class = RawTextBaseSerizlizer
    ...
    def post(self, request, *args, **kwargs):
        ...
        serializer = RawTextDetailSerizlizer(created_text)
        return Response(serializer.data)


class RawTextRetrieveView(RetrieveAPIView):
    queryset = RawText.objects.all()
    serializer_class = RawTextDetailSerizlizer
